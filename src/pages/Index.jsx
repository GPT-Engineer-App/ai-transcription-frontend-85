  ...
  return (
    <Box p={4}>
      ...
      {isLoading ? (
        ...
        <Table variant="simple" rounded="lg" border="2px solid" borderColor="gray.100">
          <Thead>
            <Tr>
              <Th>File Name</Th>
              <Th>Size</Th>
          ...
          <Tbody>
            {files.map((file, index) => (
              <Tr key={file.name} bg={index % 2 === 0 ? "gray.900" : "gray.800"} p={4} mb={4} boxShadow={index % 2 === 0 ? "lg" : "none"} rounded="lg">
